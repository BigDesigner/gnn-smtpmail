...
class GNN_SMTPMail_Updater
{
     ...
     */
    private $repo = 'BigDesigner/gnn-smtpmail';

    /**
     * Plugin slug (directory name/main file).
     */
    private $plugin_slug = 'gnn-smtpmail/gnn-smtpmail.php';

    /**
     * Transient key for caching the GitHub API response.
     */
    private $transient_key = 'gnn_smtpmail_github_update_check';
    ...
    {
        if ('plugin_information' !== $action || 'gnn-smtpmail' !== $args->slug) {
            return $result;
        }
        ...
        return (object) array(
            ...
            'author'        => 'BigDesigner',
            'homepage'      => 'https://github.com/BigDesigner/gnn-smtpmail',
    ...
    public function after_install($response, $hook_extra, $result)
    {
        ...
        $plugin_dir = WP_PLUGIN_DIR . '/gnn-smtpmail';
    ...
    {
        if (isset($_GET['gnn_smtpmail_check_update']) && '1' === $_GET['gnn_smtpmail_check_update']) {
            if (!isset($_GET['_wpnonce']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_GET['_wpnonce'])), 'gnn_smtpmail_manual_update')) {
